...
public class ModFunction extends BinaryExpression {
    private final String name;

    public ModFunction(Expression arg1, Expression arg2) {
        super(arg1, arg2);
        name = "MOD";
    }
    ...
    protected EffectiveValue evaluate(EffectiveValue o1, EffectiveValue o2) {
        ...
        if (o1.getObjType() == ObjType.STRING || o1.getObjType() == ObjType.STRING_ERROR
            ...
            throw new ArithmeticException("This MOD function only works on Doubles! (or Integers..)\n" +
