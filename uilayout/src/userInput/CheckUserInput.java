...
import buffer.SpreadsheetBuffer;
...
public class CheckUserInput {
    ...
    private final SpreadsheetBuffer buffer = new SpreadsheetBuffer();
        ...
        do {
            ...
            switch (userInput) {
                ...
                case UPDATE_SPECIFIC_CELL:
                    ...
                    buffer.updateCell(cellToUpdate, newValue);
                    break;
                case VERSIONS_PRINT:
                    buffer.getSheetVersions();
                    break;
                case EXIT_SYSTEM:
...
//package userInput;
//
//import clientServerImplementor.*;
//import FileCheck.STLSheet;
